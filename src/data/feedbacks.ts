...
export const FEEDBACKS_DATA: Feedback[] = [
...

  {
    ...
    rating: 5,
    comment:
      "Cardápio super variado e ingredientes de primeira. Consigo manter minha dieta de forma muito prática e gostosa. A equipe e o cuidado com a embalagem são impecáveis.",
    avatar:
